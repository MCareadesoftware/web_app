...
@section('welcome')
    <div class="text-zinc-600 text-center">
        ...
        <h2 class="text-1xl sm:text-2xl lg:text-4xl">Dashboard</h2><br>
        <a href="{{route('login.index')}}" class="w-1/2 justify-center rounded-md bg-indigo-600 text-teal-50 py-2 px-3">Cerrar Sesión</a>
        {{-- <form action="">
